...
UsuarioScheme.methods.onlyPublicData = function (usuarioEncontrado) {
  return {
...
UsuarioScheme.methods.onlyPublicDataall = function (usuariosEncontrado) {
  var roots = usuariosEncontrado.map(
    function (usuario) {
      return {
